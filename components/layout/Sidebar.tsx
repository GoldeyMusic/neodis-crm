...
const navItems = [
  ...
  { id: 'equipe', label: 'Équipe', icon: <svg width="15" height="15" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="5" cy="5" r="2.5"/><circle cx="11" cy="5" r="2.5"/><path d="M1 14s0-3.5 4-3.5 4 3.5 4 3.5"/><path d="M9 14s0-3.5 4-3.5 3 3.5 3 3.5"/></svg> },
